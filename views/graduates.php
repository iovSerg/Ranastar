<section id="graduates" class="portfolio">
    <div class="container section-title" data-aos="fade-up">
        <?php echo $db->GetText('GRADUATES_TITLE');?>
    </div>
    <div   id="" class="container">
        ...
        <div id="responseContainerGraduates" style="margin-top: 20px"  class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            <?php
